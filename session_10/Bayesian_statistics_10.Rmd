...
Invented by Hirotugu Aikaike | Gideon Schwartz
...
$$\text{BIC}  = - 2 \ln(f(y|\theta,\mathcal{M}_i) + 2 \ln(n)p \approx - 2 \ln(m(y|\mathcal{M}_i))$$ using a Laplace approximation. See e.g. [Hobbs and Hooten (eq. 28)](https://www.stat.colostate.edu/~hooten/papers/pdf/Hooten_Hobbs_EcolMono_2015.pdf)
