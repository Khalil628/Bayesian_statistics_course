...
\[ N_t = \frac{N_t e^{r}}{1+N_t(e^{r}-1)/K} + \epsilon_t, \; \epsilon_t \sim \mathcal{N}(0,\sigma^2) \text{ i.i.d}\]
...
\[ N_t = \frac{N_t e^{r+\epsilon_t}}{1+N_t(e^{r}-1)/K}, \; \epsilon_t \sim \mathcal{N}(0,\sigma^2) \text{ i.i.d}\]

>- The effect of $\epsilon_t$ does accumulate. $\epsilon_1$ *does* affect $N_8$. 
>- Creates *autocorrelation* between $N_t$ values
