...
\[ y_{t+1} = N_{t+1} + \epsilon_t, \; N_t = \frac{N_t e^{r}}{1+N_t(e^{r}-1)/K} \; \epsilon_t \sim \mathcal{N}(0,\sigma^2) \text{ i.i.d}\]
...
>- Makes some parameters difficult to interpret independently
