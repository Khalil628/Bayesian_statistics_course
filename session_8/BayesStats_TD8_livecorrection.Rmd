...
plot(1:Timemax,gompertz(1:Timemax,a_list[1],b_list[1],c_list[1]),xlab="time",ylab="Length",col="blue")
lines(1:Timemax,gompertz(1:Timemax,a,b,c),col="black")
for (i in 2:nlist){
  lines(1:Timemax,gompertz(1:Timemax,a_list[i],b_list[i],c_list[i]),xlab="time",ylab="Length",col="blue")
}
```
