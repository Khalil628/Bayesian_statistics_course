...
\[ Y_{ij} = \alpha_i + \epsilon_{ij}, \epsilon_{ij} \sim \mathcal{N}(0,\sigma^2)\]
Practical if $i=1,...,I$ is the same number of individuals per group. $n=I \times J$. 

\onslide<2->or again
\[ Y_{ij} \sim \mathcal{N}(\mu_{ij},\sigma^2), \mu_{ij} = \alpha_i \]
By that we mean that $\mathbb{E}(Y_{ij}) = \alpha_i$. 
